    ...
    def decryption(self):
        ...
        if self.radioButton_2.isChecked():
            ...
            if self.pic_path != '':
                ...
                rsa.n=self.Rn
                rsa.d= self.Rd
                rsa.height, rsa.width = IMG.shape[0], IMG.shape[1]
                result = rsa.decrypt_img(IMG)
                cv2.imwrite("F_result.jpg",np.array(result))
                ...
                self.textEdit_execution.setText(str(end - start)*1000)
